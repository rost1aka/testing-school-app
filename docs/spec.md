...
AUTH-11  While a user is signed in, the application header shows their name as
         the link to their profile page and offers a way to sign out, and does
         not offer links to sign in or to register. While no user is signed in,
         the header offers those links and shows neither a name nor a way to
         sign out.
...
USER-06  The profile page at /profile is the single place a user manages their
         account. It shows their email and profile form, and below them an
         Addresses section that lists their saved addresses and offers a form to
         add one. The application has no separate addresses page.
...
HOME-01  The home page tells a visitor who is not signed in what the application
         ...
         greets them by name and links to their profile, which is where their
         addresses live.
